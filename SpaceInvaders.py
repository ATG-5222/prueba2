...
class Laser(pygame.sprite.Sprite):
    ...
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("C:/Users/atg00/Pictures/Laser.png").convert()
...
class Meteor(pygame.sprite.Sprite):
    ...
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("C:/Users/atg00/Pictures/NaveEnemiga.png").convert()
        self.image.set_colorkey(negro)
        self.rect = self.image.get_rect()
...
class Player(pygame.sprite.Sprite):
    ...
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("C:/Users/atg00/Pictures/NavePrincipal.png").convert()
        self.image.set_colorkey(negro)
        self.rect = self.image.get_rect()
...
def main():
    ...
    pygame.display.set_caption("Evidencia 3 - Space Invaders")

    clock = pygame.time.Clock()
    run = True
    score = 0

    fondo = pygame.image.load("C:/Users/atg00/Pictures/Space.jfif")
